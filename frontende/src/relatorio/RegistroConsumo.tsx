...
type ItemConsumivel = Produto | Servico; 
...
export default function RegistroConsumo(props: Props) {
    ...
    const itensDisponiveis: ItemConsumivel[] = itemTipo === 'produto' ? produtos : itemTipo === 'servico' ? servicos : [];
                        ...
                        {itemTipo && (
                            <div className="mb-3">
                                ...
                                >
                                    ...
                                    {itensDisponiveis
                                        .filter((item: ItemConsumivel) => item.id !== null) 
                                        .map((item: ItemConsumivel) => (
                                            <option 
                                                key={item.id!}
